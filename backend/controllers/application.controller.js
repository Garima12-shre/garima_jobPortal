...
export const updateStatus = async (req, res) => {
  try {
    ...
    // find the application and populate applicant
    ...
    if (status.toLowerCase() === "accepted") {
      ...
      message = `Dear ${application.applicant.fullname},\n\nThank you for applying. Unfortunately, your application was not successful this time. We encourage you to apply for other openings.\n\nBest regards,\nJob Portal Team`;
    }

    await sendEmail(application.applicant.email, subject, message);
